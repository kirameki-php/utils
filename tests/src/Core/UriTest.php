...
final class UriTest extends TestCase
{
    ...
    {
        $uri = new Uri('https', 'example.com', null, '', '', '', 'user', 'pass');
        $this->assertSame('user:pass', $uri->userinfo);

        $uri = new Uri('https', 'example.com', null, '', '', '', 'user', '');
    ...
    {
        $uri = new Uri('https', 'example.com', null, '', 'key1=value1&key2=value2&key3');
        $expected = [
            'key1' => 'value1',
            'key2' => 'value2',
            'key3' => '',
    ...
    {
        $uri = new Uri('https', 'example.com', null, '', 'arr[]=1&arr[]=2&obj[key]=value');
        $expected = [
            'arr' => ['1', '2'],
            'obj' => ['key' => 'value'],
        ];
    ...
    {
        $uri = new Uri('https', 'example.com', null, '', 'key=value');
    ...
    {
        $uri = new Uri('https', 'example.com', null, '', '', 'section1');
    ...
    {
        $uri = new Uri('https', 'example.com', 8080, '/path', 'key=value', 'fragment', 'user', 'pass');
    ...
    {
        $uri = new Uri('https', 'example.com', null, '/path/to/resource');
    ...
    public function test_edge_cases_userinfo(): void
    {
        ...
        $uri = new Uri('https', 'example.com', null, '', '', '', '', 'pass');
